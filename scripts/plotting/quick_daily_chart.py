#!/usr/bin/env python3
"""
Quick Daily Trading Hours Chart
==============================

Simple script to create a daily trading hours visualization from your df_cf data.
"""
...
def plot_daily_trading_hours(df_cf, price_column='HIGH_1'):
    """
    Create a simple daily trading hours chart showing price vs time of day
    
    Parameters:
    -----------
    df_cf : pandas.DataFrame
        Your dataframe with 'Timestamp' and price column
    price_column : str
...
def run_analysis():
    """
    Run this function in your notebook after loading df_cf
    """
    print("To use this in your notebook:")
    print("1. Make sure df_cf is loaded")
    print("2. Run: plot_daily_trading_hours(df_cf, 'HIGH_1')")
    print("3. This will show when the market is most active!")
